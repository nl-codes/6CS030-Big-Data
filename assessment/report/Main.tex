...
The consensus feature importance analysis across all three regression models revealed that Phase 3 (days 60--90) features contributed the greatest aggregate importance, followed by Phase 5 and Phase 6 features. This finding is consistent with the educational literature suggesting that mid-course engagement — corresponding to the period of first major assessed work — is the strongest indicator of final performance \cite{9}. The \textit{engagement\_trend\_slope} feature and late-phase click ratios also ranked among the top predictors, confirming that students with declining engagement trajectories are at substantially elevated risk regardless of their early course performance.
